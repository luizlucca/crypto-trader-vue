...
import {
  ...
  selectionForNewTab,
} from '@market/domain/marketSelection'
import {
...
} from '@desktop/marketData'
import { dropIndicatorLayout } from '@indicators/services/indicatorLayout'
import { resetStreamLatency } from '@market/services/streamLatency'
import {
  useCandleHistoryCache,
  type CandleHistoryCache,
} from '@chart/composables/useCandleHistoryCache'
