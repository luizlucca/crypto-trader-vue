...
} from '@indicators/domain/indicatorDrawings'
...
} from '@indicators/services/indicatorReadout'
import {
  IndicatorDrawingsPrimitive,
} from '@indicators/plugins/indicator-drawings/IndicatorDrawingsPrimitive'
import {
  RoundedCandleSeries,
